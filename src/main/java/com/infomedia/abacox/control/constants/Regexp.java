package com.infomedia.abacox.control.constants;
...
public class Regexp {
    ...
    public static final String ROLENAME = "^[A-Za-z0-9]+(?:[_-][A-Za-z0-9]+)*$";
    ...
    public static final String MSG_ROLENAME = "Role name must contain only letters, numbers, underscores and hyphens";

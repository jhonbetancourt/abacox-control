package com.infomedia.abacox.control.service.common;
...
public abstract class CrudService<E, I, R extends JpaRepository<E, I> & JpaSpecificationExecutor<E>> {
    ...
    public List<E> getAllActive(){
        Specification<E> specification = (root, query, criteriaBuilder) -> criteriaBuilder.equal(root.get("active"), true);
